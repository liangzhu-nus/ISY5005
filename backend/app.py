...
#         file.save(file_path)
#         # Assuming your server is accessible via a public URL at 'http://127.0.0.1:3000/'
#         file_url = f'http://127.0.0.1:3000/{file_path}'
#         return jsonify({'message': 'File uploaded successfully', 'filename': filename, 'url': file_url}), 200
#     else:
#         return jsonify({'error': 'File type not allowed'}), 400
# ######################################################################################
#
